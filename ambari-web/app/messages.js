...
Em.I18n.translations = {
  ...
  'login.error.bad.credentials':'登录失败，无效的用户名和密码组合.',
  'login.error.disabled':'登录失败，无效的用户名和密码组合.',
  'login.error.bad.connection':'连接后台服务失败.请确认后台服务运行.',

  'titlebar.alerts.noAlerts': '无报警',
